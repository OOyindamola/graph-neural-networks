...
for ik in range(1):
	...
	for i in range(len(agents)):
		...
		duration = 30. # Duration of the trajectory
		...
		for realization in range(nRealizations):
			...
			initPosValid_ = data.getData('initPos','test')
			initVelValid_ = data.getData('initVel','test')

			print("initPosValid:", initPosValid_.shape)
